...
const ForgotPassword = () => {
    ...
    const reqForgotPassword = async (event) => {
    ...
    return (
        <>
            <header className="flex justify-center items-center bg-[#764abc] h-screen">
                <form onSubmit={reqForgotPassword} className="relative flex w-[90%] md:max-w-[40%] p-[50px] gap-[15px] flex-col bg-white rounded-xl">
